		...
		<section className='flex flex-col items-start relative overflow-hidden w-full'>
			<div className='w-full max-w-7xl px-5 mx-auto z-[1] pb-[11.875rem] max-[983px]:pb-[6rem]'>
				...
				<Image
					src={donut50}
					alt=''
					className='absolute min-[980px]:top-[59rem] sm:top-[60rem] sm:-right-44 top-[70rem] -right-48 object-cover max-[580px]:-right-32 max-[580px]:top-[70rem] max-[56px]:top-[65rem] max-[550px]:top-[70rem] md:top-[63rem] lg:top-[65rem] z-[-1] md:right-0 lg:right-12 min-[684px]:top-[50rem] max-[639px]:top-[55rem]'
				/>
			</div>
